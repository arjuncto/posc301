...
ADMINS = [
    {"name": "Carter",  "start": 1980, "end": 1980, "party": "Democrat",   "line": "#2563EB", "fill": "rgba(37,99,235,0.12)"},
    {"name": "Reagan",  "start": 1981, "end": 1988, "party": "Republican", "line": "#DC2626", "fill": "rgba(220,38,38,0.12)"},
    {"name": "Bush 41", "start": 1989, "end": 1992, "party": "Republican", "line": "#FCA5A5", "fill": "rgba(252,165,165,0.10)"},
    {"name": "Clinton", "start": 1993, "end": 2000, "party": "Democrat",   "line": "#93C5FD", "fill": "rgba(147,197,253,0.10)"},
    {"name": "Bush 43", "start": 2001, "end": 2008, "party": "Republican", "line": "#FCA5A5", "fill": "rgba(252,165,165,0.10)"},
    {"name": "Obama",   "start": 2009, "end": 2016, "party": "Democrat",   "line": "#2563EB", "fill": "rgba(37,99,235,0.12)"},
    {"name": "Trump",   "start": 2017, "end": 2020, "party": "Republican", "line": "#DC2626", "fill": "rgba(220,38,38,0.12)"},
    {"name": "Biden",   "start": 2021, "end": 2025, "party": "Democrat",   "line": "#93C5FD", "fill": "rgba(147,197,253,0.10)"},
]
    ...
    st.markdown(
        ...
        .stApp {
            background:
                ...
                radial-gradient(circle at top right, rgba(96,165,250,0.05), transparent 14%),
        ...
        .hero-card {
            ...
            border: 1px solid rgba(115,145,190,0.16);
        ...
        .stDownloadButton button {
            ...
            border: 1px solid rgba(115,145,190,0.16) !important;
...
def base_layout(title):
    return dict(
        ...
        xaxis=dict(showgrid=True, gridcolor="rgba(115,145,190,0.12)", zeroline=False, color="#E8EEF9"),
        yaxis=dict(showgrid=True, gridcolor="rgba(115,145,190,0.12)", zeroline=False, color="#E8EEF9"),
        hovermode="closest",
    )
...
# FLOATING CONTROLS
# -----------------------------
controls = st.popover("Simulation Controls", use_container_width=True)
...
recession_pts = df[df["Recession"] == 1]
...
if not recession_pts.empty:
    fig_scatter.add_trace(
        go.Scatter(
            x=recession_pts["DeficitPctGDP"],
            y=recession_pts["InflationNextYear"],
            mode="markers",
            name="Recession Year",
            marker=dict(
                size=16,
            ...
            text=recession_pts["Year"].astype(str),
...
layout2["margin"] = dict(l=20, r=20, t=70, b=90)
...
st.download_button(
    "Download CSV",
    data=csv,
    file_name="inflation_simulation_v6.csv",
    mime="text/csv",
)
