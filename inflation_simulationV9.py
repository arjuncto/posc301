...
ADMINS = [
    {"name": "Carter",  "start": 1980, "end": 1980, "party": "Democrat",   "line": "#2563EB", "fill": "rgba(37,99,235,0.10)"},
    {"name": "Reagan",  "start": 1981, "end": 1988, "party": "Republican", "line": "#DC2626", "fill": "rgba(220,38,38,0.10)"},
    {"name": "Bush 41", "start": 1989, "end": 1992, "party": "Republican", "line": "#DC2626", "fill": "rgba(220,38,38,0.10)"},
    {"name": "Clinton", "start": 1993, "end": 2000, "party": "Democrat",   "line": "#2563EB", "fill": "rgba(37,99,235,0.10)"},
    {"name": "Bush 43", "start": 2001, "end": 2008, "party": "Republican", "line": "#DC2626", "fill": "rgba(220,38,38,0.10)"},
    {"name": "Obama",   "start": 2009, "end": 2016, "party": "Democrat",   "line": "#2563EB", "fill": "rgba(37,99,235,0.10)"},
    {"name": "Trump",   "start": 2017, "end": 2020, "party": "Republican", "line": "#DC2626", "fill": "rgba(220,38,38,0.10)"},
    {"name": "Biden",   "start": 2021, "end": 2025, "party": "Democrat",   "line": "#2563EB", "fill": "rgba(37,99,235,0.10)"},
]
...
def inject_css():
    st.markdown(
        ...
        .sidebar-badge {
            ...
            border-radius: 18px;
            background: linear-gradient(135deg, #A61E2A 0%, #C62839 100%);
            color: #0B0B0B;
            font-weight: 900;
            font-size: 1.05rem;
            letter-spacing: -0.01em;
            box-shadow: 0 10px 22px rgba(166,30,42,0.20);
...
# Force administrations to appear in historical order from oldest to newest
admin_order = [admin["name"] for admin in ADMINS]
summary["Administration"] = pd.Categorical(
    summary["Administration"],
    categories=admin_order,
    ordered=True,
)
summary = summary.sort_values("Administration")

dem_summary = summary[summary["Party"] == "Democrat"]
rep_summary = summary[summary["Party"] == "Republican"]

fig_admin = go.Figure()

fig_admin.add_trace(
    go.Bar(
        x=dem_summary["Administration"],
        y=dem_summary["DeficitPctGDP"],
        name="Democrat",
        marker_color="#2563EB",
        offsetgroup="deficit",
        legendgroup="deficit_dem",
    )
)

fig_admin.add_trace(
    go.Bar(
        x=rep_summary["Administration"],
        y=rep_summary["DeficitPctGDP"],
        name="Republican",
        marker_color="#DC2626",
        offsetgroup="deficit",
        legendgroup="deficit_rep",
    )
)
...
layout3["bargap"] = 0.18
layout3["bargroupgap"] = 0.0
layout3["xaxis"]["title"] = "Administration"
# Ensure x-axis respects the historical category order
layout3["xaxis"]["categoryorder"] = "array"
layout3["xaxis"]["categoryarray"] = admin_order
